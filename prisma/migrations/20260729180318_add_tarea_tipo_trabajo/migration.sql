...
CREATE TABLE "new_Tarea" (
    ...
    CONSTRAINT "Tarea_tipoTrabajoId_fkey" FOREIGN KEY ("tipoTrabajoId") REFERENCES "TipoTrabajo" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "Tarea_serieId_fkey" FOREIGN KEY ("serieId") REFERENCES "Tarea" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Tarea" ("activo", "clienteId", "color", "createdAt", "descripcion", "estadoId", "horasEstimadas", "id", "imprevista", "nombre", "nombreBase", "orden", "ordenEstado", "parentId", "prioridad", "recurrenciaFrecuencia", "recurrenciaIntervalo", "recurrente", "serieId") SELECT "activo", "clienteId", "color", "createdAt", "descripcion", "estadoId", "horasEstimadas", "id", "imprevista", "nombre", "nombreBase", "orden", "ordenEstado", "parentId", "prioridad", "recurrenciaFrecuencia", "recurrenciaIntervalo", "recurrente", "serieId" FROM "Tarea";
DROP TABLE "Tarea";
